...
$location=$_SESSION["location"];
	$templocation=$_SESSION['templocation'];
		if (isset($_POST["search"])) {
			$templocation=$_POST['search'];
		}
...
{
	$sql="SELECT * FROM product where location='$templocation'";
$query=mysql_query($sql,$dbcon);
}
?>
	        				...
	        				<div class="wrapper">
	        					<div class="sidebar_search">
	        						<form action="shop.php" method="post">
	        							<input type="text" name="search" placeholder="locationhere">
