		...
		<div class="main_page">
							...
							<div class="about-text">
								...
								<div class="icon-box">
									<div class="single-item">
										...
										<div class="name color1"><?php echo $row['location'] ?></div>
									</div>
									<div class="single-item">
										<div class="icon"><i class="icon-nature-1"></i></div>
										<div class="count">phone no</div>
										<div class="name color1"><?php echo $row['phno'] ?></div>
									</div>
			...
			<footer>
				...
				<div class="bottom_footer clear_fix">
					<div class="container">
						<h6 class="pull-left">Copyrights © 2017 All Rights Reserved by<a href="http://themeforest.net/user/steelthemes/portfolio" target="_blank">farmu</a></h6>
