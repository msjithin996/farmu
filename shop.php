...
<!-- Mirrored from steelthemes.com/demo/html/organic_store/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 18 Mar 2017 09:07:58 GMT -->
<head>
		<meta charset="UTF-8">
		<!-- For IE -->
							   			...
							   			<div class="login-info">
									   		...
									   		<!-- select menu -->
							                        ...
							                        <div class="g-input f1 mb-30">
															...
															<li><a href="account.html">Sign/Register</a></li>
				...
				<div class="container">
					<nav class="menuzord pull-left" id="main_menu">
					   <ul class="menuzord-menu">
					      ...
					      <li class="current_page"><a href="shop.php">Store</a>
					            ...
					            <div class="col-md-4 col-sm-6 col-xs-12 default-item" style="display: inline-block;">
					                <div class="inner-box">
					                    <div class="single-item center">
					                        ...
					                        <div class="content">
					                        	<h3><a href="shop-single.php?id=<?php echo $row['productname'] ?>"><?php echo $row['productname'] ?></a></h3>
					                        ...
					                        <div class="overlay-box">
					                        	<div class="inner">
						                        	...
						                        	<div class="bottom-content">
						                        		<h4><a href="shop-single.php?id=<?php echo $row['productname'] ?>">DESCREPTION</a></h4>
								...
								<div class="best_sellers clear_fix wow fadeInUp">
									...
									<div class="best_selling_item clear_fix border">
										...
										<div class="text float_left">
											<a href="shop-single.html"><h6>Apple</h6></a>
											<ul>
									...
									<div class="best_selling_item clear_fix border">
										...
										<div class="text float_left">
											<a href="shop-single.html"><h6>banana</h6></a>
											<ul>
												<li><i class="fa fa-star" aria-hidden="true"></i></li>
												<li><i class="fa fa-star" aria-hidden="true"></i></li>
												<li><i class="fa fa-star" aria-hidden="true"></i></li>
									...
									<div class="best_selling_item clear_fix">
										...
										<div class="text float_left">
											<a href="shop-single.html"><h6>carrot</h6></a>
											<ul>
												<li><i class="fa fa-star" aria-hidden="true"></i></li>
												<li><i class="fa fa-star" aria-hidden="true"></i></li>
												<li><i class="fa fa-star" aria-hidden="true"></i></li>
